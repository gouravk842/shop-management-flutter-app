...
Future<Uint8List> generateInvoice(
  ...
  for (var element in productList) {
    products.add(Product(i.toString(), element['name'], element['rate'],
        element['quantity'].toInt()));
    i += 1;
  }

  String termsAndCondition = 'sdfgfg';
...
class Invoice {
  ...
  Future<Uint8List> buildPdf(PdfPageFormat pageFormat) async {
    ...
    _logo = await rootBundle.loadString('assets/icons/logo.svg');
    _bgShape = await rootBundle.loadString('assets/icons/invoice.svg');
  ...
  pw.Widget _contentTable(pw.Context context) {
    const tableHeaders = ['Sr.', 'Item Name', 'Rate', 'Quantity', 'Total'];
